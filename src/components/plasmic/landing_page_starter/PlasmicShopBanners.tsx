...
import * as sty from "./PlasmicShopBanners.module.css"; // plasmic-import: TTSbv7Byagwq/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <Banner
              className={classNames("__wab_instance", sty.banner__p75N)}
            />

            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__qhZVe)}
            >
              <Banner
                className={classNames("__wab_instance", sty.banner__dsNnb)}
              >
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__gnlyy)}
                  role={"img"}
                  src={
              ...
              <Banner
                className={classNames("__wab_instance", sty.banner__icIn6)}
              >
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__wsnjX)}
                  role={"img"}
                  src={
