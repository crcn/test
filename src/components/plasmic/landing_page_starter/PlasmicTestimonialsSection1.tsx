...
import * as sty from "./PlasmicTestimonialsSection1.module.css"; // plasmic-import: 7-Isjg5BxQT7/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__dvO7X)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__u4Grw)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__pYr2Z)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__bhk9J)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__v24Q7)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__dr1RZ)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__ad5Kk)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img___7LPz)}
                    role={"img"}
                    src={
