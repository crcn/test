...
import * as sty from "./PlasmicCallToActionSection1.module.css"; // plasmic-import: PH1uqmC286I-/css
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__memP)}
                  role={"img"}
                  src={
                ...
                <div
                  className={classNames(defaultcss.all, sty.freeBox___4SsY)}
                />
              </React.Fragment>
            ),
            value: args.art
            ...
            defaultContents: (
              <React.Fragment>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__kocG)}
                >
                  <div
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__vZ6V)}
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__f1I69)}
                  ...
                  <Button
                    ...
                    className={classNames("__wab_instance", sty.button__nwa4Y)}
